...
type Plugin interface {
	CreatePluginWithRating(ctx context.Context, pluginDto types.PluginCreateDto) (*types.PluginDto, error)
	GetPluginWithRating(ctx context.Context, pluginId string) (*types.PluginDto, error)
...
func (s *PluginService) CreatePluginWithRating(ctx context.Context, pluginDto types.PluginCreateDto) (*types.PluginDto, error) {
	var plugin *types.PluginDto
...
func (s *PluginService) GetPluginWithRating(ctx context.Context, pluginId string) (*types.PluginDto, error) {
	var plugin *types.PluginDto
	err := s.db.WithTransaction(ctx, func(ctx context.Context, tx pgx.Tx) error {
		var err error
